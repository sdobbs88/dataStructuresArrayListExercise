...
* Description: Adds names, compares them to other strings and outputs the results
* of the comparison. 
* Due: 10/05/2016
...
public class Exercise24_01 {
    interface MyList<E> extends java.util.Collection<E> {
        ...
        @Override
        public default boolean addAll(Collection<? extends E> d) {
            for (Object obj : d) {
                add((E) obj);
            }
            return true;
        ...
        @Override
        public default boolean removeAll(Collection<?> d) {
        ...
        @Override
        public default boolean retainAll(Collection<?> d) {
        ...
        @Override
        public default <T> T[] toArray(T[] argArray) {
            T[] array0 = (T[]) new String[argArray.length];
